...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    yield page.type('#tbCompany', process.env.CREWSCHEDULER_CREDENTIALS.company);
    yield page.type('#tbUserName', process.env.CREWSCHEDULER_CREDENTIALS.login);
    yield page.type('#tbPassword', process.env.CREWSCHEDULER_CREDENTIALS.password);
